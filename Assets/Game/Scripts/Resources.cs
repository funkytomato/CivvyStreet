...
namespace Eliot.AgentComponents
{
	...
	public class Resources
	{
        ...
        [SerializeField] private bool _recoverOverTime = true;
        [SerializeField] private int _recoverAmount = 1;
        [SerializeField] private float _recoverCoolDown = 5;
        [Space]
        [Header("Other")] 
        ...
        public static Resources CreateResources(bool useHealth = false, int maxHealth = 10, bool useEnergy = false,
			int maxEnergy = 10, bool useIntoxication = false, int maxIntoxication = 10)
		{
        ...
        /// <summary>
        /// Replenish Agent's Intoxication.
        /// </summary>
        /// <param name="value"></param>
        ...
        /// <summary>
        /// Replenish random amount of Agent's Intoxication in specified range.
        /// </summary>
        /// <param name="minValue"></param>
        /// <param name="maxValue"></param>
        ...
        public void Update()
		{
            ...
            if (_useIntoxication && _addIntoxicationOverTime && Time.time >= _lastTimeAddedIntoxication + _addIntoxicationCoolDown)
            {
                AddIntoxication(_addIntoxicationAmount);
                _lastTimeAddedIntoxication = Time.time;
            }
        }
